...
from organizer.views import tag_list, tag_detail, startup_list, startup_detail, tag_form
from organizer.views import redirect_root

urlpatterns = [
    url(r'^$', redirect_root),
    url(r'^tag/create/$', tag_form, name='organizer_tag_create'),
